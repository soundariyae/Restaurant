	 ...
	 */
		 ...
		 */
			 ...
			 */
                        me.chart = me;
                        me.controller = me;
                        // chart.chart.controller #inception
		 ...
		 */
                    linear: function(tickValue, index, ticks) {
                        ...
                        if (tickValue !== 0) {
                            ...
                            tickString = '0';
                            // never show decimal places for 0
                        }
                        ...
                        if (title.length) {
                            ...
                            len = title.length; i < len; ++i) {
                                ...
                                if (i + 1 === title.length) {
                                    ...
                                    // If Last, add margin, remove spacing
                                }
                            }
                        }
                    },
        ...
        38: [function(require, module, exports) {
            ...
            module.exports = Element.extend({
                ...
                draw: function(chartArea) {
                    ...
                    var errMargin = 1.01;
                    // 1.01 is margin for Accumulated error. (Especially Edge, IE.)
                    var ratio = 0;
		 ...
		 */
                    ...
                    getPixelForValue: function(value) {
                        ...
                        if (me.isHorizontal()) {
                            ...
                            sign *= -1;
                            // invert, since the upper-left corner of the canvas is at pixel (0, 0)
 ...
 */
		 ...
		 */
                    getLabelCapacity: function(exampleTime) {
                        ...
                        // Pick the longest format for guestimation
